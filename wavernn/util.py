...
def is_dual_channels_quantize(s):
    return s == 'dual_channels_quantize'
...
def waveplot(path, y_hat, y_target, hparams, sample_rate=22050):
    sr = hparams.sample_rate if hparams is not None else sample_rate
